...
<div class="partition-card">
    ...
    <div class="partition-card-footer">
        @auth
            {{-- CORRECTION ICI : Remplacement de route('partitions.show') par # --}}
            <a href="#" class="partition-link">
                View details
            </a>
        @else
        ...
        <div class="partition-actions">
            @can('update', $partition)
                {{-- CORRECTION ICI : Remplacement de route('partitions.edit') par # --}}
                <a href="#" class="partition-action partition-action-edit" title="Edit">
            ...
            @can('delete', $partition)
                {{-- CORRECTION ICI : Remplacement de route('partitions.destroy') par # --}}
                <form action="#" method="POST" onsubmit="return confirm('Are you sure you want to delete this score?');">
                    @csrf
                    @method('DELETE')
